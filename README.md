...
- 📊 **One-screen dashboard** — today's spend, window totals, trends, and sparklines, all above the fold
...
|------|---------|-------------|
| `--days N` | `14` | Window for dashboard totals, charts, raw tables, sparklines, and explicit daily/growth views |
